	...
	<div class="main-container">
		...
		<div class="footer-section">
			<div class="inside-footer-section">
				...
				<div class="footer-section-two footer-columns">
					<a href="#">ABOUT</a>
					<a href="#">FAQ</a>
					<a href="#">CONTACT</a>
				</div>
				<div class="footer-section-three footer-columns">
					<a href="#">INSTAGRAM</a>
					<a href="#">FACEBOOK</a>
					<a href="#">LINKEDIN</a>
				</div>
				<div class="footer-section-four footer-columns">
